...
function printHelp() {
	...
	echo "       -F: local MSP base directory, default=./fabric/common/tools/cryptogen/crypto-config"
	...
	echo " "
	echo "Example:"
	echo "   ./gen_network.sh -a create -x 2 -p 2 -r 2 -o 1 -k 1 -z 1 -t kafka -d goleveldb -F /root/gopath/src/github.com/hyperledger/fabric-test/fabric/common/tools/cryptogen/crypto-config -G ./fabric/msp/crypto-config "
	echo "   ./gen_network.sh -a create -x 2 -p 2 -r 2 -o 1 -k 1 -z 1 -t kafka -d goleveldb -F /root/gopath/src/github.com/hyperledger/fabric-test/fabric/common/tools/cryptogen/crypto-config -G ./fabric/msp/crypto-config -S enabled "
	echo " "
	exit
}
...
nOrderer=1
nCA=0
MSPDIR="$CURRENTDIR/fabric/common/tools/cryptogen/crypto-config"
...
if [ $Req == "create" ]; then
	...
	echo "Test mode will not bring up the network."

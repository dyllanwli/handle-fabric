...
function printHelp {
   ...
   echo "    -b: MSP directory, default=./common/tools/cryptogen/crypto-config"
   ...
   echo " "
   echo "Example:"
   echo " ./gen_configtx_cfg.sh -o 1 -k 1 -p 2 -r 2 -h SHA2 -s 256 -t kafka -b ./fabric/common/tools/cryptogen/crypto-config -w 10.120.223.35 -v 1 -v 3"
   exit
}
...
SecType="256"
PROFILE_STRING="test"
MSPBaseDir="./common/tools/cryptogen/crypto-config"
comName="example.com"
batchTimeOut="2s"
batchSize=10
